...
EmLastMonthKPIView = function () {
    Ax.tpl.LibRptTpl.apply(this, arguments);
    this.vcl.funcView.add('createChart', { name: 'createChart', display: 'KPI图表' });
};
var proto = EmLastMonthKPIView.prototype = Object.create(Ax.tpl.LibRptTpl.prototype);
proto.constructor = EmLastMonthKPIView;

proto.createChart = function () {
    return EMsysKPIChart2.build(this, true, "DAY");
};
EMsysKPIChart = {
        ...
        dt.each(function (rec) {
            if (idx < 10) {
                ...
                series.push({
                    ...
                    title: Ext.isEmpty(producelinename) ? "生产线" : producelinename
                });
            }
        });
                ...
                series.push({
                    ...
                    tips: {
                        ...
                        renderer: function (storeItem, item) {
                            ...
                            var html = "<div>产线：" + producelinename + "<br/>日期：" + time + "<br/>OEE：" + parseFloat(v * 100).toFixed(2) + "%</div>";
                            this.setTitle(html);
                        }
                    },
