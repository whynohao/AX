...
var proto = comBomProdView.prototype = Object.create(Ax.tpl.LibBillTpl.prototype);
proto.constructor = comBomProdView;
proto.tree;
proto.onReady = function (billAction, curPks, isF4, lookVersionObj, changeView) {
    ...
    if (vcl.tpl.Layout.GridRange != null) {
        bodyPanel = Ext.create('Ext.form.Panel', {
    ...
    var treePanel = Ext.create('Ext.tree.Panel', {
        ...
        listeners: {
            ...
            edit: function (obj, e) {
                ...
                else if (e.field == "MATERIALID") {//虚拟件
