comStructTechRouteView = function () {
    Ax.tpl.LibBillTpl.apply(this, arguments);
    if (this.vcl.funcView.containsKey("default")) {
        this.vcl.funcView.get("default").name = "onStructTechReady";
    }
    //只有第一列的双击才可以打开
    this.canExpend = true;
...
var proto = comStructTechRouteView.prototype = Object.create(Ax.tpl.LibBillTpl.prototype);
proto.constructor = comStructTechRouteView;

proto.onStructTechReady = function (billAction, curPks, isF4, lookVersionObj, changeView) {
    var me = this;
    var vcl = this.vcl;
    vcl.forms = [];
    if (changeView !== true) {
...
proto.createTree = function (gridInfo) {
    ...
    function GetLoading() {
        ...
        var obj = vcl.GetTreeStoreData1(true, vcl.dataSet.getTable(1), 0, 0, masterRow);
    ...
    var treePanel = Ext.create('Ext.tree.Panel', {
        ...
        listeners: {
                        ...
                        items: [{
                            ...
                            handler: function () {
                                ...
                                for (var fieldName in newRow.data) {
                                    if (fieldName != "id" && fieldName != "expanded" && fieldName != "leaf")
            ...
            //用以下两个事件会有问题，一个是执行了setRootNode就会没有以下两个事件了
