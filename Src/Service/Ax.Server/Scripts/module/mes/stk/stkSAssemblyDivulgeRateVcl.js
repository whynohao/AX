...
stkSAssemblyDivulgeRateVcl = function () {
...
var proto = stkSAssemblyDivulgeRateVcl.prototype = Object.create(Ax.vcl.LibVclGrid.prototype);
proto.constructor = stkSAssemblyDivulgeRateVcl;
