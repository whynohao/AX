stkPurStockOutVcl = function () {
    Ax.vcl.LibVclData.apply(this, arguments);
};
var proto = stkPurStockOutVcl.prototype = Object.create(Ax.vcl.LibVclData.prototype);
proto.constructor = stkPurStockOutVcl;
var attId = 0;
var bodyRow;
        ...
        case LibEventTypeEnum.ButtonClick:
            if (this.isEdit) {
                if (e.dataInfo.fieldName == "BtnLoadData") {
                    ...
                    else if (contactsObjectId == "" || contactsObjectId == null) {
                        alert("往来单位不能为空！");
                    }
                    else {
                        Ax.utils.LibVclSystemUtils.openDataFunc('stk.PurStockOutQuery', '采购退货出库数据查询', [companyId, contactsObjectId, this]);
                    }
                }
            }
            else {
                alert("单据只有在修改状态才能载入采购退货出库数据！");
            }
            break;
