stkMaterialElectronicLedgerRptVcl = function () {
    Ax.vcl.LibVclRpt.apply(this, arguments);
};
var proto = stkMaterialElectronicLedgerRptVcl.prototype = Object.create(Ax.vcl.LibVclRpt.prototype);
proto.constructor = stkMaterialElectronicLedgerRptVcl;
...
proto.vclHandler = function (sender, e) {
    ...
    switch (e.libEventType) {
        case LibEventTypeEnum.ColumnDbClick:
            ...
            var progId;
            var displayName;
            switch (e.dataInfo.dataRow.data["STKMOVETYPE"]*1) {
                case 100:
                case 101:
