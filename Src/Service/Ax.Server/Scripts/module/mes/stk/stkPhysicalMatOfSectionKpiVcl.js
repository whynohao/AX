...
stkPhysicalMatOfSectionKpiVcl = function () {
    ...
    this.summaryRenderer.TotalRateFun = function (v, sd, f) {
        ...
        if (sd.record.data['MATERIALNUM' + idx] != 0) {
            ...
            if (value >= 0) {
                return '<span style="color:green;">' + (value * 100).toFixed(2) + '%</span>';
            }
            else {
...
var proto = stkPhysicalMatOfSectionKpiVcl.prototype = Object.create(Ax.vcl.LibVclGrid.prototype);
proto.constructor = stkPhysicalMatOfSectionKpiVcl;
