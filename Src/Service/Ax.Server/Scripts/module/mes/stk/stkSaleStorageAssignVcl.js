stkSaleStorageAssignVcl = function () {
    Ax.vcl.LibVclDataFunc.apply(this, arguments);
    this.dataRow;
};
var proto = stkSaleStorageAssignVcl.prototype = Object.create(Ax.vcl.LibVclDataFunc.prototype);
proto.constructor = stkSaleStorageAssignVcl;

//界面加载
proto.doSetParam = function () {
    var returnList = this.invorkBcf("GetSaleStorageData", [0]);
...
proto.vclHandler = function (sender, e) {
    ...
    if (e.libEventType == LibEventTypeEnum.ButtonClick) {
        if (e.dataInfo.fieldName == "btnSelect") {
            ...
            var returnList = this.invorkBcf("GetSaleStorageData", [masterRow.data["TASKTYPE"]]);
            FillMaintainData.call(this, returnList);
        }
