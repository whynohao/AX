stkSaleStockOutVcl = function () {
    Ax.vcl.LibVclData.apply(this, arguments);
};
var proto = stkSaleStockOutVcl.prototype = Object.create(Ax.vcl.LibVclData.prototype);
proto.constructor = stkSaleStockOutVcl;
var attId = 0;
var bodyRow;
        ...
        case LibEventTypeEnum.ButtonClick:
            if (this.isEdit) {
                if (e.dataInfo.fieldName == "BtnLoadData") {
                    Ax.utils.LibVclSystemUtils.openDataFunc('stk.SaleStockOutQuery', '销售出库单数据查询', [this]);
                }
            }
            else {
                alert("单据只有在修改状态才能载入销售出库数据！");
            }
            break;
