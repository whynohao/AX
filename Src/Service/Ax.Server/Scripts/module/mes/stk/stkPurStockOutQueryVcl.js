...
stkPurStockOutQueryVcl = function () {
    Ax.vcl.LibVclDataFunc.apply(this, arguments);
};
var proto = stkPurStockOutQueryVcl.prototype = Object.create(Ax.vcl.LibVclDataFunc.prototype);
proto.constructor = stkPurStockOutQueryVcl;
    ...
    try {
        ...
        if (list !== undefined && list.length > 0) {
            for (var i = 0; i < list.length; i++) {
                ...
                newRow.set('FROMBILLNO', info.FrombillNo);//来源采购入库单号
                ...
                newRow.set('COMPANYID', info.OrgId);// 仓库名称  空
                ...
                newRow.set('DEALQUANTITY', info.DealQuantity);//交易数量
...
function fillStockInData(returnData) {
    debugger;
    var grid = Ext.getCmp(proto.winId + 'STKPURSTOCKOUTDETAILGrid')
    var list = returnData;
    Ext.suspendLayouts();
    ...
    switch (e.libEventType) {
        case LibEventTypeEnum.ButtonClick:
            ...
            if (e.dataInfo.fieldName == "BTNSELECT") {
                ...
                var fromBillNo = this.dataSet.getTable(0).data.items[0].data["FROMBILLNO"];//销售出库单号
                //var fromRowId = this.dataSet.getTable(0).data.items[0].data["FROMROWID"];//销售出库单行标识
            ...
            if (e.dataInfo.fieldName == "BTNSAVE") {
                ...
                for (var i = 0; i < bodyTable.data.items.length; i++) {
                    list.push({
                        ...
                        FrombillNo: bodyTable.data.items[i].data["FROMBILLNO"],//来源采购入库单号
                        ...
                        OrgId: bodyTable.data.items[i].data["COMPANYID"],//隶属公司
                        ...
                        DealQuantity: bodyTable.data.items[i].data["DEALQUANTITY"],//交易数量
