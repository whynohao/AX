...
stkSaleBackStockInQueryVcl = function () {
    Ax.vcl.LibVclDataFunc.apply(this, arguments);
};
var proto = stkSaleBackStockInQueryVcl.prototype = Object.create(Ax.vcl.LibVclDataFunc.prototype);
proto.constructor = stkSaleBackStockInQueryVcl;
...
function fillStockInData(returnData) {
    debugger;
    var grid = Ext.getCmp(winId + 'STKSALEBACKSTOCKINDETAILGrid')
    var list = returnData;
    Ext.suspendLayouts();
        ...
        case LibEventTypeEnum.ButtonClick:
            ...
            if (e.dataInfo.fieldName == "BTNSELECT") {
                ...
                if (contactObjectId == "" || contactObjectId == undefined) {
                    ...
                    //}
                    //this.win.close();
                    var data = this.invorkBcf('GetData', [companyId, contactObjectId, fromBillNo, materialId, materialTypeId, type]);
            ...
            if (e.dataInfo.fieldName == "BTNSAVE") {
                ...
                for (var i = 0; i < bodyTable.data.items.length; i++) {
                    list.push({
                        ...
                        DealQuantity: bodyTable.data.items[i].data["DEALQUANTITY"],// 数量
