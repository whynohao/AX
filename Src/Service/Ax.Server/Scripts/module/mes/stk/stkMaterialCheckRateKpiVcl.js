...
stkMaterialCheckRateKpiVcl = function () {
    ...
    this.summaryRenderer.TotalRateFun = function (v, sd, f) {
        ...
        if (sd.record.data['STANDTIME' + idx] != 0) {
            var value = sd.record.data['CHECKTIME' + idx] / sd.record.data['STANDTIME' + idx];
            if (value >= 0) {
...
var proto = stkMaterialCheckRateKpiVcl.prototype = Object.create(Ax.vcl.LibVclGrid.prototype);
proto.constructor = stkMaterialCheckRateKpiVcl;
