stkBorrowStockOutVcl = function () {
    Ax.vcl.LibVclData.apply(this, arguments);
};
var proto = stkBorrowStockOutVcl.prototype = Object.create(Ax.vcl.LibVclData.prototype);
proto.constructor = stkBorrowStockOutVcl;
var attId = 0;
var bodyRow;
    ...
    switch (e.libEventType) {
        case LibEventTypeEnum.Validated:
            ...
            if (e.dataInfo && e.dataInfo.tableIndex == 0) {
                ...
                var borrowTime = e.dataInfo.dataRow.get('BORROWTIME');
                if (e.dataInfo.value != null) {
                    if (e.dataInfo.fieldName == "BORROWTIME") {
                        for (var i = 0; i < this.dataSet.getTable(1).data.items.length; i++) {
                            this.dataSet.getTable(1).data.items[i].set("BORROWTIME", borrowTime);
                        }
                    }
        ...
        case LibEventTypeEnum.AddRow:
            if (e.dataInfo.tableIndex == 1) {
                ...
                var borrowTime = masterRow.get('BORROWTIME');
                e.dataInfo.dataRow.set("BORROWTIME", borrowTime);
            }
            break;
