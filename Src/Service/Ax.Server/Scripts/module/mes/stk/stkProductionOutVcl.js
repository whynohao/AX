stkProductionOutVcl = function () {
    Ax.vcl.LibVclData.apply(this, arguments);
};
var proto = stkProductionOutVcl.prototype = Object.create(Ax.vcl.LibVclData.prototype);
proto.constructor = stkProductionOutVcl;
var attId = 0;
var bodyRow;
            ...
            if (e.dataInfo.fieldName == "BtnLoadData") {
                if (this.isEdit) {
                    ...
                    if (personId == "") {
                        ...
                        Ax.utils.LibVclSystemUtils.openDataFunc('stk.ProductionOutQuery', '生产领料出库单数据查询', [this, personId, personName]);
                    }
                }
                else {
                    alert("单据只有在修改状态才能载入生产领料出库单数据！");
                }
            }
        ...
        case LibEventTypeEnum.FormClosed:
            if (bodyRow != undefined) {
                if (bodyRow.data["QUANTITY"] == 0 || bodyRow.data["QUANTITY"] == "") {
                    ...
                    //this.forms[1].loadRecord(bodyRow);
                }
            }
            break;
    }
