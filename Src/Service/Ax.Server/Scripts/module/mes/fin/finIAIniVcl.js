finIAIniVcl = function () {
    Ax.vcl.LibVclData.apply(this, arguments);
    this.attId = 0;
};
var proto = finIAIniVcl.prototype = Object.create(Ax.vcl.LibVclData.prototype);
proto.constructor = finIAIniVcl;
proto.vclHandler = function (sender, e) {
    Ax.vcl.LibVclData.prototype.vclHandler.apply(this, arguments);
    switch (e.libEventType) {
        //case LibEventTypeEnum.Validating:
        //    if (e.dataInfo.fieldName == "MATERIALID") {
        //        if (!this.invorkBcf("MatIsIA", [e.dataInfo.value])) {
        //            Ext.Msg.alert("提示", "物料并没有启用存货核算！");
        //            e.dataInfo.cancel = true;
        //        }
        //    }
        //    break;
        case LibEventTypeEnum.Validated:
            if (e.dataInfo.fieldName == "INIQTY") {
                e.dataInfo.dataRow.set("INIAMOUNT", e.dataInfo.value * e.dataInfo.dataRow.get("INIPRICE"));
            }
            else if (e.dataInfo.fieldName == "INIPRICE") {
                e.dataInfo.dataRow.set("INIAMOUNT", e.dataInfo.value * e.dataInfo.dataRow.get("INIQTY"));
            }
            else if (e.dataInfo.fieldName == "INIAMOUNT") {
                if (e.dataInfo.dataRow.get("INIQTY") > 0) {
                    e.dataInfo.dataRow.set("INIPRICE", e.dataInfo.value / e.dataInfo.dataRow.get("INIQTY"));
                }
            }
            break;
