finARIniQuantityVcl = function () {
    Ax.vcl.LibVclData.apply(this, arguments);
};
var proto = finARIniQuantityVcl.prototype = Object.create(Ax.vcl.LibVclData.prototype);
proto.constructor = finARIniQuantityVcl;
var attId = 0;
...
proto.vclHandler = function (sender, e) {
    ...
    switch (e.libEventType) {
        ...
        case LibEventTypeEnum.Validated:
            if (e.dataInfo.tableIndex == 1)
            {
                if (e.dataInfo.fieldName == "WAREOUTSALQTY")
                {
                    e.dataInfo.dataRow.set("WAREOUTQTY", e.dataInfo.value);
                    e.dataInfo.dataRow.set("NOINVOICESALQTY", e.dataInfo.value);
                    e.dataInfo.dataRow.set("NOINVOICEQTY", e.dataInfo.value);
                }
