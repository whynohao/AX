finAPAgingAnalysisRptVcl = function () {
    Ax.vcl.LibVclRpt.apply(this, arguments);
};
var proto = finAPAgingAnalysisRptVcl.prototype = Object.create(Ax.vcl.LibVclRpt.prototype);
proto.constructor = finAPAgingAnalysisRptVcl;
...
proto.showRpt = function (condition) {
    ...
    if (this.win !== undefined) {
        ...
        delete Ext.data.Model.schema.entities["fin.APAgingAnalysisRptFINARAGINGANALYSIS"];
        delete Ext.data.Model.schema.entityClasses["fin.APAgingAnalysisRptFINARAGINGANALYSIS"];
