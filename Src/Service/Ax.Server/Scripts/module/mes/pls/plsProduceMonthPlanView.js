...
plsProduceMonthPlanView = function () {
...
var proto = plsProduceMonthPlanView.prototype = Object.create(Ax.tpl.LibBillTpl.prototype);
proto.constructor = plsProduceMonthPlanView;
...
proto.Gantt = {
    createGantt: function (vcl) {
        ...
        //function calcDuration(v1, v2, unit) {
        //    v1 = v1.toString();
        //    v2 = v2.toString();
        //    var start = new Date(v1.substr(0, 4), v1.substr(4, 2), v1.substr(6, 2), v1.substr(8, 2), v1.substr(10, 2), v1.substr(12, 2)).getTime();
        //    var end = new Date(v2.substr(0, 4), v2.substr(4, 2), v2.substr(6, 2), v2.substr(8, 2), v2.substr(10, 2), v2.substr(12, 2)).getTime();
        //    var diff = start - end;
        //    if (unit == 'h') {
        //        diff = diff / (3600 * 1000)
        //    } else if (unit == 'mi') {
        ...
        var gantt = Ext.create("MthPlan.DemoGanttPanel", {
            ...
            calcTime: function (v, isStart) {
                function toLibDateTime(v) {
                    return (v.getFullYear() * 10000 + (v.getMonth() + 1) * 100 + v.getDate()) * 1000000 + v.getHours() * 10000 + v.getMinutes() * 100 + v.getSeconds();
                }
                v = toLibDateTime(v);
