plsLogisticsSendRptVcl = function () {
    Ax.vcl.LibVclDailyRpt.apply(this, arguments);
};
var proto = plsLogisticsSendRptVcl.prototype = Object.create(Ax.vcl.LibVclDailyRpt.prototype);
proto.constructor = plsLogisticsSendRptVcl;
...
proto.print = function () {
    ...
    var strHead = "<div align=center><strong><font size = '5px'> " + ShortTodateTime(planLogisticsDate) + "物流发货报表</font></strong></div>";
    ...
    for (var i = 0; i < dt.length; i++) {
        ...
        strTableTrHtml += "<th>" + ShortTodateTimeTwo(dt[i].data["SINGLEDATE"]) + "</th>";
