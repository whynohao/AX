plsThreeMonthAccuracyRateVcl = function () {
    Ax.vcl.LibVclGrid.apply(this, arguments);
    this.summaryRenderer.TotalRateFun = function (v, sd, f) {//v代表当前列汇总值，sd包含各列汇总值，f代表当前列字段名
        var idx = '';
        var regx = /^[0-9]*$/;
...
var proto = plsThreeMonthAccuracyRateVcl.prototype = Object.create(Ax.vcl.LibVclGrid.prototype);
proto.constructor = plsThreeMonthAccuracyRateVcl;
