...
namespace AxCRL.Template.DataSource
{
    public static class DataSourceHelper
    {
        ...
        public static void AddFixColumn (DataTable table, BillType billType)
        {
            ...
            DataSourceHelper.AddColumn (new DefineField (table, "CREATETIME", "创建时间") { DataType = LibDataType.Int64, ControlType = LibControlType.DateTime, AllowCopy = false, ReadOnly = true });
