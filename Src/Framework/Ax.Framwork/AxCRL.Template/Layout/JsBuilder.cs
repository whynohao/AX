...
namespace AxCRL.Template.Layout
{
    ...
    public static class JsBuilder
    {
        ...
        {
            string ret = @"[{xtype: 'container',layout: { type: 'table', columns: 4 }, style: { marginTop: '6px', marginBottom: '6px' },
            ...
            foreach (var item in fields) {
                ...
                { builder.Append (string.Format ("{0},", BuildField (item))); }
                    ...
                    builder.AppendFormat ("width:{0},colspan:{1}", 300 * count, count);
                    builder.Append ("},");
                    count = 4;
                    builder.Append (string.Format ("{0},", BuildField (item)));
                }
        ...
        public static string BuildField (LayoutField field)
        {
            ...
            { builder.AppendFormat ("width:300,colspan:{0},", field.ColumnSpan); }
            
            else
            { builder.AppendFormat ("width:{0},colspan:{1},", 300 * field.ColumnSpan, field.ColumnSpan); }
